//
//  EmptyCompleteGoalScreen.swift
//  ListApp
//
//  Created by tobi adegoroye on 03/12/2021.
//
import UIKit

class EmptyCompleteGoalScreen: UIView {
    ...
    lazy var goalLabel: UILabel = {
        ...
        goalLabel.text = "Sorry you have no completed life goals. Please press the + button to create some life goals."
